...
import { getDriverName } from '../../config/motoboys';
                    ...
                    <div key={col.id} className="flex-1 min-w-[300px]">
                        ...
                        <div className="space-y-3">
                            {orders
                                ...
                                .map(order => {
                                    console.log('Card Render:', order.id, 'Status:', order.status, 'DriverID:', order.driverId, 'MotoboyID:', order.motoboyId);
                                    return (
                                                    ...
                                                    <>
                                                        <div className="mb-2 p-2 bg-gray-100 rounded flex items-center gap-2">
                                                            ...
                                                            <span className="text-xs font-bold text-gray-700">
                                                                {getDriverName(order.driverId) || order.driverName || 'Aguardando...'}
                                                            </span>
                                                        </div>
                                                        <Button
                                                            size="sm"
